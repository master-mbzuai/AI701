...
if __name__ == "__main__":
    ...
    for key in data.keys():
        ...
        plt.scatter(numbers, params, alpha=0.5, label='Parameters')
    ...
    plt.title('Number of parameters vs Compression - d - 100 epochs')
    plt.xlabel('Number')
    plt.ylabel('Number of Params')
    #plt.colorbar(label='Parameters (KMac)')
    plt.grid(True)
    plt.savefig("../results/_images/params-" + "-".join(legends) + ".jpg")
    plt.show()    
